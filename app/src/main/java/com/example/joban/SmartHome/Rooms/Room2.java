...
public  class Room2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(Room2.this);
                ...
                mBuilder.setPositiveButton(R.string.ok_label, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int which) {
                        ...
                        ArrayAdapter<Model> itemsAdapter =
                                new MyCustomArrayAdapter(Room2.this, stringList);
    ...
    public void tbclick(View v)
    {
        ...
        if(toggleStatus)
        {
            ...
            as.execute("R2"+s,et);
            Toast.makeText(Room2.this, "R2"+s, Toast.LENGTH_SHORT).show();

        }
        else
        {
            Toast.makeText(Room2.this, "Off", Toast.LENGTH_SHORT).show();
