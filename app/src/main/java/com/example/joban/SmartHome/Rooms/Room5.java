...
public  class Room5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(Room5.this);
                ...
                mBuilder.setPositiveButton(R.string.ok_label, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int which) {
                        ...
                        ArrayAdapter<Model> itemsAdapter =
                                new MyCustomArrayAdapter(Room5.this, stringList);
    ...
    public void tbclick(View v)
    {
        ...
        if(toggleStatus)
        {
            ...
            as.execute("R5"+s,et);
            Toast.makeText(Room5.this, "R5"+s, Toast.LENGTH_SHORT).show();

        }
        else
        {
            Toast.makeText(Room5.this, "Off", Toast.LENGTH_SHORT).show();
