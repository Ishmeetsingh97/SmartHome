...
public  class Room9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(Room9.this);
                ...
                mBuilder.setPositiveButton(R.string.ok_label, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int which) {
                        ...
                        ArrayAdapter<Model> itemsAdapter =
                                new MyCustomArrayAdapter(Room9.this, stringList);
    ...
    public void tbclick(View v)
    {
        ...
        if(toggleStatus)
        {
            ...
            as.execute("R9"+s,et);
            Toast.makeText(Room9.this, "R9"+s, Toast.LENGTH_SHORT).show();

        }
        else
        {
            Toast.makeText(Room9.this, "Off", Toast.LENGTH_SHORT).show();
