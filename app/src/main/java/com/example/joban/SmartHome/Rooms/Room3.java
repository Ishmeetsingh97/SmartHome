...
public  class Room3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(Room3.this);
                ...
                mBuilder.setPositiveButton(R.string.ok_label, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int which) {
                        ...
                        ArrayAdapter<Model> itemsAdapter =
                                new MyCustomArrayAdapter(Room3.this, stringList);
    ...
    public void tbclick(View v)
    {
        ...
        if(toggleStatus)
        {
            ...
            as.execute("R3"+s,et);
            Toast.makeText(Room3.this, "R3"+s, Toast.LENGTH_SHORT).show();

        }
        else
        {
            Toast.makeText(Room3.this, "Off", Toast.LENGTH_SHORT).show();
