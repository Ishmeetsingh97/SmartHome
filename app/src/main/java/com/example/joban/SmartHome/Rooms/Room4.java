...
public  class Room4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(Room4.this);
                ...
                mBuilder.setPositiveButton(R.string.ok_label, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int which) {
                        ...
                        ArrayAdapter<Model> itemsAdapter =
                                new MyCustomArrayAdapter(Room4.this, stringList);
    ...
    public void tbclick(View v)
    {
        ...
        if(toggleStatus)
        {
            ...
            as.execute("R4"+s,et);
            Toast.makeText(Room4.this, "R4"+s, Toast.LENGTH_SHORT).show();

        }
        else
        {
            Toast.makeText(Room4.this, "Off", Toast.LENGTH_SHORT).show();
